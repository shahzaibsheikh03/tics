...
import 'home.dart';
User? loggedInUser;
Color greyBlue = const Color(0xff8cccff);
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> verifyPhone(String number,String username) async {
  ...
  Future<void> verifyOTP() async {
    await FirebaseAuth.instance.signInWithCredential(
      PhoneAuthProvider.credential(
       ...
       FirebaseService().insertData(_username, countryDial+_phone.number,);
                          ...
                          onTap: () {
                            ...
                            if(screenState == 0) {
                              if(usernameController.text.isEmpty) {
                                ...
                                verifyPhone(countryDial + phoneController.text,usernameController.text);
                              }
                            } else {
                              if(otpPin.length >= 6) {
                                verifyOTP();
